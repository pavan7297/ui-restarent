...
import { TablesComponent } from './components/tables component/tables/tables.component';
...
import { AddtableComponent } from './components/tables component/addtable/addtable.component';

export const routes: Routes = [
  { path: '', redirectTo: 'Dashboard', pathMatch: 'full' },
  { path: 'new-order', component: DashboardComponent },
  { path: 'order', component: OrderComponent },
  { path: 'items', component: ItemsComponent },
  { path: 'add-items', component: AddItemsComponent },
  { path: 'tables', component: TablesComponent },
  { path: 'add-tables', component: AddtableComponent },
